        ...
        <View style={styles.parcelHeader}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.parcelAddress}>
              <Text style={styles.addressLabel}>Felvétel: </Text>
              {order.pickup_address}
              {"\n"}
              <Text style={styles.addressLabel}>Kiszállítás: </Text>
          ...
          <TouchableOpacity
            style={[
              ...
              expandedParcelId === order.id && styles.detailsButtonActive,
            ]}
            onPress={() =>
              setExpandedParcelId(
                expandedParcelId === order.id ? null : order.id,
              )
            }
          >
            <AntDesign
        ...
        {expandedParcelId === order.id && (
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.detailItem}>
              ...
              <Text style={styles.detailText}>
                Futár:{" "}
                {order.courier_id ? `ID #${order.courier_id}` : "Keresés..."}
              </Text>
            </View>
          </View>
        )}
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        >
          <View
            style={[styles.sidebarCard, { width: isMobile ? "100%" : 280 }]}
          >
            <View style={styles.sidebarSection}>
              <Text style={styles.sidebarSectionTitle}>Csomagkezelés</Text>
              <TouchableOpacity
                style={styles.mainActionBtn}
                onPress={() => router.push("/user/sendParcel")}
              >
              ...
              <TouchableOpacity
                ...
                onPress={() => router.push("/user/returnParcel")}
              >
            ...
            {loading ? (
              ...
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptyText}>
                  Jelenleg nincs aktív rendelésed.
                </Text>
              </View>
            )}
          </View>
